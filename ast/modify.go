...
func Modify(node Node, modifier ModifierFunc) Node {
    ...
    case *Program:
		for i, statemment := range node.Statements {
			node.Statements[i], _ = Modify(statemment, modifier).(Statement)
		}
